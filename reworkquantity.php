...
if ($data['Position'] != '2') {
    header("Location: passquantity.php");
    exit;
}
?>
        ...
        <div class="container">
            ...
            <div class="header">
                <div class="header-label">
                    ...
                    <label style="color: orange;">Step: <?php echo  $data['Step'] . ' (Re-Work)'; ?></label></br>

                </div>

                <div></br></br></br>
                    <label style="font-size:20px"><strong><?php echo 'Re-Work process is going on...'; ?></strong></label>
                </div>
            ...
            <div class="body">
                ...
                <a href="reworkpassquantity.php"><button class="button pass-button">Pass</button></a>
                <a href="reworkfailquantity.php"><button class="button fail-button">Fail</button></a>
                <a href="reworkrejectquantity.php"><button class="button reject-button">Reject</button></a>
            </div>
